...
print(RobinCar::robincar_linear(df = dfSim, treat_col = "A", response_col = "y", covariate_cols = c("Xc", "Xb"), adj_method = "ANHECOVA")$result)
```
...
ANHECOVASim_est <- do.call(bind_rows, lapply(dfSim_List, function(x){RobinCar::robincar_linear(df = dfSim, treat_col = "A", response_col = "y", covariate_cols = c("Xc", "Xb"), adj_method = "ANHECOVA")$result$estimate}))
